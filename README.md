...
- number of mistakes per message (кол-во ошибок сделаных в сообшении пропуск/дублирование буквы, 1 = одна ошибка в каждом сообшении, 0-1 = от одной до двух ошибок на сообшение)
...
- Если вы получили вл, и уровень не сыграл в этом роль: 0%
